...
func (h *Handler) partialEdgeLinkForm(w http.ResponseWriter, r *http.Request) {
	...
	fmt.Fprintf(w, `<dialog id="edge-link-modal" class="modal" aria-labelledby="edge-link-title">
...
func (h *Handler) partialEdgeUnlinkForm(w http.ResponseWriter, r *http.Request) {
	...
	fmt.Fprintf(w, `<dialog id="edge-unlink-modal" class="modal" aria-labelledby="edge-unlink-title">
